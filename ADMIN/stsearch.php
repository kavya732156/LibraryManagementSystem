...
<table width="100%" border="0" cellspacing="01" cellpadding="01">
  ...
  <tr>
	...
	<option value="ISE" <?php if($row['stream']=='ISE') echo 'selected="selected"'; ?>>ISE</option>
	<option value="Civil" <?php if($row['stream']=='Civil') echo 'selected="selected"'; ?>>Civil</option>
        <option value="COM" <?php if($row['stream']=='COM') echo 'selected="selected"'; ?>>COM</option>
        <option value="EEE" <?php if($row['stream']=='EEE') echo 'selected="selected"'; ?>>EEE</option>
	<option value="ECE" <?php if($row['stream']=='ECE') echo 'selected="selected"'; ?>>ECE</option>
	<option value="Mech" <?php if($row['stream']=='Mech') echo 'selected="selected"'; ?>>Mech</option>          
        </select></td>
    <td>&nbsp;</td>
  </tr>
