...
<body>
  ...
  <tr bgcolor="#cb64e8">
    ...
    <th width="15%" scope="col"><a href="mail.php">Meesage</a></th>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" align="center">
        <tr bgcolor="beige">   <th><h4>&nbsp;</h4></th>
            <th><input  style="width: 5em;  height: 2em; font-size: 15px;" type="submit" value="Compose" name="compose"/></th>
                ...
                <th>&nbsp;</th>
                <th><input style="width: 8em;  height: 2em; font-size: 15px;" type="submit" value="Sent Message" name="sent"/></th>
                <th>&nbsp;</th>
        </tr>
                <?php
                ...
                <tr>
                    ...
                    <td colspan="3" align="center">
                        <br/><br/>
                        <div style="background-color: beige; width: 40%; margin-left: 5%; border:red;">
                        <br/><br/>
                        <font size="5"> To : &nbsp;&nbsp;</font> 
                        <?php
                        include '../connection.php';
