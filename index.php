...
<table width="100%"  cellspacing="00" cellpadding="00">
  <tr bgcolor="#459aa3">
    ...
    <th width="62%" scope="col"><font size="8" color="White">Project Management System</font></th>
  ...
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><br/><br/><div style="width:50%;background-color:#f5dea4;margin-left:24%;margin-top:100px;border:1px solid black;">
    	<br><br>
